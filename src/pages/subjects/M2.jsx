...
const resources = [
  {
    ...
    type: "PDF",
    category: "Unit 1",
    url: "https://drive.google.com/file/d/1B3OLT-bHPS0WGO8OZo2xQxFS1VuW7ov1/view?usp=drive_link",
  },
  {
    title: "Unit 2.pdf",
    type: "PDF",
    category: "Unit 2",
    url: "https://drive.google.com/file/d/1csGLjLJYXdtvBg8e6-LmVxfPQ23mDHGG/view?usp=drive_link",
  },
  {
    title: "Unit-3.pdf",
    type: "PDF",
    category: "Unit 3",
    url: "https://drive.google.com/file/d/1kooPT1TRQL3dhSqVqkt8MLo9fo7gdH33/view?usp=drive_link",
  },
  {
    title: "Unit-4.pdf",
    type: "PDF",
    category: "Unit 4",
    url: "https://drive.google.com/file/d/1gVX5qJXw3_RJUdQLkUyoYm7gGpx43AN_/view?usp=drive_link",
  },
  {
    title: "Unit-5.pdf",
    type: "PDF",
    category: "Unit 5",
    url: "https://drive.google.com/file/d/15Zgr9HnyhVLRkFWIKqx5l7v8wvOFLFAi/view?usp=drive_link",
  },
  {
    title: "M2 Important",
    type: "DOC",
    category: "Important Questions",
    url: "https://docs.google.com/document/d/1naPiMvedI8HxN0GjtW8fFFEntyfMzVK0vlb0DdqVbFA/edit?usp=drive_link",
  }
];
function ODEVC() {
  ...
  return (
    <SubjectPage subjectName="Ordinary Differential Equations and Vector Calculus (ODEVC)">
      <div>
        <div className="mb-8">
  <input
    type="text"
